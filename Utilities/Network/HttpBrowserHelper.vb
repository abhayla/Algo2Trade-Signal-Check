Imports NLog
Namespace Network
    Public Module HttpBrowserHelper
#Region "Logging and Status Progress"
        Public logger As Logger = LogManager.GetCurrentClassLogger
#End Region

#Region "Private Attributes"
        Dim userAgents As New List(Of String) From {
...
#Region "Public Methods"
        Public Function GetRandomUserAgent() As String
            logger.Debug("Getting random user agent")
            Dim rnd As New Random()
            Dim x As String = userAgents(rnd.Next(userAgents.Count))
            Return x
        End Function
#End Region
    End Module
