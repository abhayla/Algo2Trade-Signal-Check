...
#Region "Enums"
        Public Enum TypeOfException
            PossibleReloginRequired = 1
            ExceptionInBetweenLoginProcess
            PossibleCaptcha
        End Enum
#End Region
...
#Region "Public Properties"
        ...
        Public Property WebPageSays As Object
#End Region
...
#Region "Constructors"
        ...
        Public Sub New(ByVal message As String, ByVal inner As Exception, ByVal webPageSays As Object, ByVal exceptionType As TypeOfException)
            MyBase.New(message, inner)
            Me.WebPageSays = webPageSays
            Me.ExceptionType = exceptionType
        End Sub
